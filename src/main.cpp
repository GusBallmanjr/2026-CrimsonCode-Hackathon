...
int main(int argc, char* argv[]) {
  ...
  if (flag1 == "--help") {
    std::cout << "ogre-enc | public / private key encryption" << std::endl << "--help | prints this list" << std::endl << "-create-keys <name> | creates a set of public / private keys" << std::endl << "-encrypt <decrypted-file> <public-key> | encrypts file with public key" << std::endl << "-decrypt <encrypted-file> <private-key> | decrypts file with private key" << std::endl;
  }
    ...
    std::cout << "ogre requires proper arguments. See --help for more info" << std::endl;
  }
